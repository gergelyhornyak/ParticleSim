...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_initParticles')) {
        Object.defineProperty(Module['ready'], '_initParticles', { configurable: true, get: function() { abort('You are getting _initParticles on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_initParticles', { configurable: true, set: function() { abort('You are setting _initParticles on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_updateParticles')) {
        Object.defineProperty(Module['ready'], '_updateParticles', { configurable: true, get: function() { abort('You are getting _updateParticles on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_updateParticles', { configurable: true, set: function() { abort('You are setting _updateParticles on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_getParticles')) {
        Object.defineProperty(Module['ready'], '_getParticles', { configurable: true, get: function() { abort('You are getting _getParticles on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_getParticles', { configurable: true, set: function() { abort('You are setting _getParticles on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
/** @type {function(...*):?} */
var _initParticles = Module["_initParticles"] = createExportWrapper("initParticles");
