...
var wasmBinaryFile;
  wasmBinaryFile = 'moving_square.wasm';
...
var ASM_CONSTS = {
  1024: function($0, $1, $2, $3) {const canvas = document.getElementById('canvas'); const ctx = canvas.getContext('2d'); ctx.clearRect(0, 0, $0, $1); ctx.fillStyle = "red"; ctx.fillRect($2, $3, 50, 50);}
};
...
/** @type {function(...*):?} */
var _move_square = Module["_move_square"] = createExportWrapper("move_square");

/** @type {function(...*):?} */
var _render_square = Module["_render_square"] = createExportWrapper("render_square");
